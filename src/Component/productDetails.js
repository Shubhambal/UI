...
function ProductDetails() {
  ...
  useEffect(() => {
    ...
    fetch(`https://server4-route-hitendra7-dev.apps.sandbox-m4.g2pi.p1.openshiftapps.com/api/productsById/${p_Id}`)
      .then((res) => res.json())
      .then((data) => {
        setProduct(data);
    ...
    fetch(`https://server4-route-hitendra7-dev.apps.sandbox-m4.g2pi.p1.openshiftapps.com/api/productDetailsById/${p_Id}`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const handleAddToCart = () => {
    if (sessionStorage.getItem('email')) {
      ...
      if (productDetails) {
        ...
        fetch('https://server4-route-hitendra7-dev.apps.sandbox-m4.g2pi.p1.openshiftapps.com/api/add', {
          method: 'POST',
          headers: {
