...
<Container className="Homecard-cont">
  <h1 style={{ color: 'blue', marginLeft:50 }}><b>Shop here..</b></h1>
...
//     </Container>
//     </Card>
//     <p style={{ color: 'black' }}><b>{product.p_Name}</b></p>
//     <p>&#8377; {product.p_Price}</p>
//     </Link>
//     ))}
//   </div>
