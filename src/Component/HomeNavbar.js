...
function HomeNavbar() {
  ...
  <i class="fa fa-search fa-2x"></i>
            ...
            <a href='/cart' className='btn btn-outline-light mx-3 '>
  <i className='fa fa-shopping-cart fa-2x'> <h5>Cart</h5></i>
</a>

              <a href='/login' className='btn btn-outline-light mx-3'>
                <i className='fa fa-sign-in fa-2x'></i> <h5>Login</h5>
              </a>
              <a href='/register' className='btn btn-outline-light mx-2'>
                <i className='fa fa-user-plus fa-2x'></i> <h5>Register</h5>
              </a>
            </div>
          </div>
        </div>
