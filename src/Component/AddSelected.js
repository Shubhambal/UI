...
export default function AddSelected() {
  ...
  useEffect(() => {
    const apiUrl = `https://server3-route-hitendra7-dev.apps.sandbox-m4.g2pi.p1.openshiftapps.com/admins/${url}/1`;
  ...
  const handleSubmit = (e) => {
    ...
    fetch(`https://server3-route-hitendra7-dev.apps.sandbox-m4.g2pi.p1.openshiftapps.com/admins/${url}`, {
      method: "POST",
